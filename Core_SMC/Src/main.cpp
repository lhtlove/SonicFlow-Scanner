...
int main(void)
{
  ...
  cconfSetup(chopper_config_);
  currentSetup(driver_current_);

  write(ADDRESS_GCONF, global_config_.bytes, &huart3);
  write(ADDRESS_CHOPCONF, chopper_config_.bytes, &huart3);
  write(ADDRESS_IHOLD_IRUN, driver_current_.bytes, &huart3);
...
//
//	    dc_encoder_update(0, E1A, E1B);
//	    //dc_encoder_update(1, E2A, E2B);
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim) {
	if (htim -> Instance == stepper1.htim_stepper -> Instance) Stepper_TIM_Interrupt();
