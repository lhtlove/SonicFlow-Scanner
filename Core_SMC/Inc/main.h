...
#define Motor1_2_Pin GPIO_PIN_4
#define Motor1_2_GPIO_Port GPIOA
#define Motor2_1_Pin GPIO_PIN_5
#define Motor2_1_GPIO_Port GPIOA
#define Motor2_2_Pin GPIO_PIN_6
#define Motor2_2_GPIO_Port GPIOA
#define CAN_SPEED_Pin GPIO_PIN_7
#define CAN_SPEED_GPIO_Port GPIOA
#define STEP_Pin GPIO_PIN_0
#define STEP_GPIO_Port GPIOB
#define DIR_Pin GPIO_PIN_1
#define DIR_GPIO_Port GPIOB
#define E2_B_Pin GPIO_PIN_12
#define E2_B_GPIO_Port GPIOB
#define E2_A_Pin GPIO_PIN_13
#define E2_A_GPIO_Port GPIOB
#define E1_B_Pin GPIO_PIN_11
#define E1_B_GPIO_Port GPIOA
#define E1_A_Pin GPIO_PIN_12
