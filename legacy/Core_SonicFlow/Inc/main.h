...
#define RECV_A0_Pin GPIO_PIN_3
#define RECV_A0_GPIO_Port GPIOA
#define RECV_A1_Pin GPIO_PIN_4
#define RECV_A1_GPIO_Port GPIOA
#define RECV_EN_Pin GPIO_PIN_5
#define RECV_EN_GPIO_Port GPIOA
...
#define SEL_IN1_Pin GPIO_PIN_3
#define SEL_IN1_GPIO_Port GPIOB
